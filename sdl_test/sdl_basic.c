 ...
 */
static inline SDL_Texture *render_text(SDL_Renderer *ren, TTF_Font *font,
                                       SDL_Color color, const char *displ,
                                       SDL_Rect *optimal_size) {
...
static bool main_loop(void) {
  ...
  window =
      SDL_CreateWindow("sdl_basic", SDL_WINDOWPOS_CENTERED,
